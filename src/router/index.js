...

    {
      ...
      children: [
        ...
        },
        {
          path: 'ponentes',
          name: 'ponentes',
          meta: { title: 'Ponentes', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/ponentes/PonentesView.vue'),
        },
        {
          path: 'nuevo-ponente',
          name: 'nuevo-ponente',
          meta: { title: 'Nuevo Ponente', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/ponentes/NuevoPonenteView.vue'),
        },
               {
          path: 'editar-ponente/:id',
          name: 'editar-ponente',
          meta: { title: 'Editar Ponente', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/ponentes/EditarPonenteView.vue'),
        },

        {
          path: 'eventos',
          name: 'eventos',
          meta: { title: 'Eventos', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/eventos/EventosView.vue'),
        },
        {
          path: 'nuevo-evento',
          name: 'nuevo-evento',
          meta: { title: 'Nuevo Evento', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/eventos/NuevoEventoView.vue'),
        },
        {
          path: 'categorias',
          name: 'categorias',
          meta: { title: 'Categorías', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/categorias/CategoriasView.vue'),
        },
        {
          path: 'nueva-categoria',
          name: 'nueva-categoria',
          meta: { title: 'Nueva Categoría', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/categorias/NuevaCategoriaView.vue'),
        },
        {
          path: 'listado-paquetes',
          name: 'listado-paquetes',
          meta: { title: 'Paquetes', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/paquetes/PaquetesView.vue'),
        },
        {
          path: 'nuevo-paquete',
          name: 'nuevo-paquete',
          meta: { title: 'Nuevo Paquete', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/paquetes/NuevoPaqueteView.vue'),
        },
        {
          path: 'regalos',
          name: 'regalos',
          meta: { title: 'Regalos', middleware: ['auth', 'verified', 'is_admin'] },
          component: () => import('../views/admin/regalos/RegalosView.vue'),
        },
        {
          path: 'nuevo-regalo',
          name: 'nuevo-regalo',
          meta: { title: 'Nuevo Regalo', middleware: ['auth', 'verified', 'is_admin'] },
